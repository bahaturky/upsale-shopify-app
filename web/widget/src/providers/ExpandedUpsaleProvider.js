...
const ExpandedUpsaleProvider = memo(function ExpandedUpsaleProvider({ children, items, ...props }) {
  ...
  return (
    <ExpandUpsaleContext.Provider value={setExpandedUpsaleId}>
      {expandedUpsale ? <ExpandedUpsale upsale={expandedUpsale} {...props} /> : children}
